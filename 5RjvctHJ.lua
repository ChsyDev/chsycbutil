...
local Window = Library:CreateWindow({
    Name = "chsy's counterblox utils",
    LoadingTitle = "loading ccu..",
    LoadingSubtitle = "ccu by chsy",
    ConfigurationSaving = {
        Enabled = false,
        FolderName = "ccuCounterBlox", -- Create a custom folder for your hub/game
        FileName = "ccuCounterB"
    },
    Discord = {
        Enabled = false,
    ...
    KeySettings = {
        Title = "chsy's counterblox utils | Key System",
        Subtitle = "Private Key.",
        Note = "This key is handed out.",
        FileName = "chsykeysystemccu", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
        SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
        GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
        Key = {"chsy2025"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
})
